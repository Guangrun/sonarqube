...
public class CompressBuiltInRulesProfiles extends DataChange {
  ...
  public CompressBuiltInRulesProfiles(Database db) {
    super(db);
  }
  ...
  protected void execute(Context context) throws SQLException {
    ...
    markDefaultOrgProfilesAsBuiltIn(context);
  }

  private static void markDefaultOrgProfilesAsBuiltIn(Context context) throws SQLException {
    String defaultOrganizationUuid = getDefaultOrganizationUuid(context);

    MassUpdate massUpdate = context.prepareMassUpdate();
    massUpdate.select("select rp.kee from rules_profiles rp " +
      "where rp.organization_uuid = ?")
